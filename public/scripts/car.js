class Car extends Component {
  ...
  constructor(id, plate, manufacture, model, image, rentPerDay, capacity, description, transmission, available, type, year, options, specs, availableAt) {
    super(id, plate, manufacture, model, image, rentPerDay, capacity, description, transmission, available, type, year, options, specs, availableAt);
  }
  ...
  render() {
    return `
      <div class="container-lg card-deck">
      <div class="search-card" sytle="width=100%">
        <div class="card p-2 mb-2">
          <div class="card-body">
            ...
            <div>
              <p class="mt-4">${(this.available) ? "Dengan Supir" : "Tanpa Supir"}</p>
              <p class="mb-2">${this.manufacture}/${this.type}</p>
            </div>
            <div>
